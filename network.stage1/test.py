...
def main():
    ...
    for z in range(len(dataset)):
        # print (dataset[z]["img"][0])
        outputData[z] = {#"img": dataset[z]["img"][0],
                         "meta": dataset[z]["img_metas"]}#[0].data}
    ...
    if rank == 0:
        if args.out:
            ...
            for k in range(len(outputs)):
                outputData[k]["pred"] = outputs[k]

            joblib.dump(outputData, args.out)
